...
{% macro td__format_timestamp(column_name) %}
    FORMAT_DATETIME({{column_name}}, 'YYYY-MM-dd HH:mm:ss')
{% endmacro %}

{% macro td__in_date_window(target, start_date, end_date) %}
